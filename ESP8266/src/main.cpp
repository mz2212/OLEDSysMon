		...
		switch(mode) {
			...
			case 2:
				switch(timeClient.getDay()) {
					case 0:
						u8g2.drawStr(0, 16, "Sunday");
						break;
					case 1:
						u8g2.drawStr(0, 16, "Monday");
						break;
					case 2:
						u8g2.drawStr(0, 16, "Tuesday");
						break;
					case 3:
						u8g2.drawStr(0, 16, "Wednesday");
						break;
					case 4:
						u8g2.drawStr(0, 16, "Thursday");
						break;
					case 5:
						u8g2.drawStr(0, 16, "Friday");
						break;
					case 6:
						u8g2.drawStr(0, 16, "Saturday");
						break;
					default:
